...
func (r *Recovery) S(names ...string) *Recovery { _ = "STUB: not implemented"; return nil }

func (r *Recovery) Bytes(bytes bytes.Bytes) *Recovery { _ = "STUB: not implemented"; return nil }

func (r *Recovery) Format(format string) *Recovery { _ = "STUB: not implemented"; return nil }

func (r *Recovery) Help(help bool) *Recovery { _ = "STUB: not implemented"; return nil }

func (r *Recovery) Time(time timeunit.TimeUnit) *Recovery { _ = "STUB: not implemented"; return nil }

func (r *Recovery) V(v bool) *Recovery { _ = "STUB: not implemented"; return nil }
