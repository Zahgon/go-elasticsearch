...
func (r *Segments) S(names ...string) *Segments { _ = "STUB: not implemented"; return nil }

func (r *Segments) Local(local bool) *Segments { _ = "STUB: not implemented"; return nil }

func (r *Segments) MasterTimeout(duration string) *Segments { _ = "STUB: not implemented"; return nil }
...
func (r *Segments) AllowClosed(allowclosed bool) *Segments { _ = "STUB: not implemented"; return nil }

func (r *Segments) Bytes(bytes bytes.Bytes) *Segments { _ = "STUB: not implemented"; return nil }

func (r *Segments) Format(format string) *Segments { _ = "STUB: not implemented"; return nil }

func (r *Segments) Help(help bool) *Segments { _ = "STUB: not implemented"; return nil }

func (r *Segments) Time(time timeunit.TimeUnit) *Segments { _ = "STUB: not implemented"; return nil }

func (r *Segments) V(v bool) *Segments { _ = "STUB: not implemented"; return nil }
