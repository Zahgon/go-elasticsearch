...
func (r *DeleteJob) _jobid(jobid string) *DeleteJob { _ = "STUB: not implemented"; return nil }

func (r *DeleteJob) Force(force bool) *DeleteJob { _ = "STUB: not implemented"; return nil }
