...
func (r *GetJobs) JobId(jobid string) *GetJobs { _ = "STUB: not implemented"; return nil }

func (r *GetJobs) AllowNoMatch(allownomatch bool) *GetJobs { _ = "STUB: not implemented"; return nil }
