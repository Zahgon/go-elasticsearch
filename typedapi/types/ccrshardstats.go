...
func (s *CcrShardStats) UnmarshalJSON(data []byte) error { _ = "STUB: not implemented"; return nil }

func NewCcrShardStats() *CcrShardStats { _ = "STUB: not implemented"; return nil }
