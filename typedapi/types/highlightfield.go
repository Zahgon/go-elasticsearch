...
func (s *HighlightField) UnmarshalJSON(data []byte) error { _ = "STUB: not implemented"; return nil }

func NewHighlightField() *HighlightField { _ = "STUB: not implemented"; return nil }
