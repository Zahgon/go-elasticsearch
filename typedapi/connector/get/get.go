...
func (r *Get) _connectorid(connectorid string) *Get { _ = "STUB: not implemented"; return nil }

func (r *Get) IncludeDeleted(includedeleted bool) *Get { _ = "STUB: not implemented"; return nil }
