...
func (r *Put) ConnectorId(connectorid string) *Put { _ = "STUB: not implemented"; return nil }
...
func (r *Put) Description(description string) *Put { _ = "STUB: not implemented"; return nil }

func (r *Put) IndexName(indexname string) *Put { _ = "STUB: not implemented"; return nil }

func (r *Put) IsNative(isnative bool) *Put { _ = "STUB: not implemented"; return nil }

func (r *Put) Language(language string) *Put { _ = "STUB: not implemented"; return nil }

func (r *Put) Name(name string) *Put { _ = "STUB: not implemented"; return nil }

func (r *Put) ServiceType(servicetype string) *Put { _ = "STUB: not implemented"; return nil }
