...
func (r *Search) Index(index string) *Search { _ = "STUB: not implemented"; return nil }
...
func (r *Search) Knn(knns ...types.KnnSearchVariant) *Search { _ = "STUB: not implemented"; return nil }
