...
func (r *GetStats) MasterTimeout(duration string) *GetStats { _ = "STUB: not implemented"; return nil }

func (r *GetStats) Timeout(duration string) *GetStats { _ = "STUB: not implemented"; return nil }
