...
func (r *Status) Repository(repository string) *Status { _ = "STUB: not implemented"; return nil }

func (r *Status) Snapshot(snapshot string) *Status { _ = "STUB: not implemented"; return nil }
