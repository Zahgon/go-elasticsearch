...
func (r *Delete) _repository(repository string) *Delete { _ = "STUB: not implemented"; return nil }

func (r *Delete) _snapshot(snapshot string) *Delete { _ = "STUB: not implemented"; return nil }
