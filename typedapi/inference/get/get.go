...
func (r *Get) TaskType(tasktype string) *Get { _ = "STUB: not implemented"; return nil }

func (r *Get) InferenceId(inferenceid string) *Get { _ = "STUB: not implemented"; return nil }
