...
func (r *Get) AllowNoIndices(allownoindices bool) *Get { _ = "STUB: not implemented"; return nil }
...
func (r *Get) FlatSettings(flatsettings bool) *Get { _ = "STUB: not implemented"; return nil }

func (r *Get) IgnoreUnavailable(ignoreunavailable bool) *Get { _ = "STUB: not implemented"; return nil }

func (r *Get) IncludeDefaults(includedefaults bool) *Get { _ = "STUB: not implemented"; return nil }

func (r *Get) Local(local bool) *Get { _ = "STUB: not implemented"; return nil }

func (r *Get) MasterTimeout(duration string) *Get { _ = "STUB: not implemented"; return nil }

func (r *Get) Features(features ...feature.Feature) *Get { _ = "STUB: not implemented"; return nil }
