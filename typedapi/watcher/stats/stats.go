...
func (r *Stats) Metric(metrics ...string) *Stats { _ = "STUB: not implemented"; return nil }

func (r *Stats) EmitStacktraces(emitstacktraces bool) *Stats { _ = "STUB: not implemented"; return nil }
